...
<div class="w3-top">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px;color:white" id="band">
    <h2 class="w3-wide">Cyber Security as a Service in Cloud Computing </h2>
		...
		<form action="masterkeycheck.jsp" method="post">
		<fieldset>
				<legend><h4 style="max-width:800px;color:white">Data Owner - Master Key Authentication</h4></legend>
					
			
					<div class="main">
						<div class="form-left-to-w3l">

							<input type="text" name="mkey" placeholder="Enter Master Key" required="" style="width:350px;">
							<div class="clear"></div>
						</div>
