...
<div class="w3-top">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px;color:white" id="band">
    <h2 class="w3-wide">Cyber Security as a Service in Cloud Computing </h2>
		...
		<fieldset>
				<legend><h4 style="max-width:800px;color:white">Data Owner Request</h4></legend>
	<table class="table">
        <thead>
          <tr> 
            <th>ID</th>
...
try
	...
	String qry =" select  * from owner_register"; 
	...
	String uid1=rs.getString("id");%>
	     <tr class="info"> 
            ...
            <td><a href="mkeygenerate1.jsp?uid=<%=uid1%>&&email1=<%=rs.getString("email")%>" style="color:blue;text-decoration:none;font-size:20px;"> <%=rs.getString("status")%> </a> </td>
          </tr>
