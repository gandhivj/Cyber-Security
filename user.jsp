...
<div class="w3-top">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px;color:white" id="band">
    <h2 class="w3-wide">Cyber Security as a Service in Cloud Computing </h2>
		...
		<fieldset>
				<legend><h4 style="max-width:800px;color:white">User Login</h4></legend>
					...
					<p style="font-family:georgia;font-size:20px;color:orange;">New User?
					&nbsp;&nbsp;&nbsp;<a href="user_register.jsp" style="color:orange;">Register</a></p><hr/>
		</fieldset>
		</form>
	</div>
</body>
